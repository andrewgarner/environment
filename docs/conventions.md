...
- **Attribute sets** (`sessionVariables`, `shellAbbrs`, `packages`, etc.) are ordered logically — group related entries together, alphabetically within a group where order doesn't matter.
